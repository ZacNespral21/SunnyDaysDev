            ...
            <div className="container-fluid p-0 m-0">
              <div className="hero">
                <div className="hero__title">
                  <h2>The smart hiring solution.</h2>
                  <h5>Save time and money sourcing and hiring local, qualified, and insured workers with GigSmart's Get Workers staffing platform.</h5>
                </div>
              </div>
          ...
          <section className="vh-50">
            <div className="container-fluid p-0 m-0">
              <div className="hero">
                <div className="hero__title">
                  <h2>The smart hiring solution.</h2>
                  <h5>Save time and money sourcing and hiring local, qualified, and insured workers with Chambita's Get Workers staffing platform.</h5>
                </div>
              </div>
